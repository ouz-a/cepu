...
use crate::{
    branch_exc_sys_instr::{
        Bcond, Bl, Blr, Br, Branch, Bti, Cbnz, Cbz, Ccmni, Ccmpi, Chkfeat, Csdb, Csinc, Csinv, Dmb,
        Eret, Mrs, MsrImm, MsrReg, Ret, Sevl, Smc, Svc, Sys, Tbnz, Tbz, Wfe, Wfi, Xpaclri, Yield,
    },
    cpu::Cpu,
    imm_instr::{AddImmediate, Extr, Movk, Movn, Movz, Sbc, SubImmediate, Subs},
    load_store_instr::{
        Ldar, Ldarb, Ldaxr, LdpPostIndex, LdpPreIndex, LdpSignedOffset, LdpswPostIndex,
        LdpswPreIndex, LdpswSignedOffset, LdrImmPostIdx, LdrImmPreIdx, LdrImmUnOffset, LdrLit,
        LdrReg, LdrUnpriv, LdrbPostIndex, LdrbPreIndex, LdrbRegister, LdrbUnpriv, LdrbUnsignedOff,
        LdrhImmPostIndex, LdrhImmPreIndex, LdrhImmUnOffset, LdrhRegister, LdrhUnpriv,
        LdrsbImmPostIndex, LdrsbImmPreIndex, LdrsbImmUnsignedOffset, LdrsbReg, LdrshImmPostIndex,
        LdrshImmPreIndex, LdrshImmUnsignedOffset, LdrswImmPostIndex, LdrswImmPreIndex,
        LdrswImmUnOffset, LdrswRegister, Ldur, Ldurb, Ldurh, Ldursw, Ldxp, Ldxr, Ldxrb, Prfm,
        StlrNoOffset, Stlrb, Stlrh, Stlxp, Stlxr, Stlxrb, Stnp, StpPostIndex, StpPreIndex,
        StpSignedOffset, StrImmPostIndex, StrImmPreIndex, StrImmUnOffset, StrRegister, StrUnpriv,
        StrbImmUnOffset, StrbPostIndex, StrbPreIndex, StrbRegister, StrbUnpriv, Strh,
        StrhPostIndex, StrhPreIndex, StrhUnpriv, StrhUnsigned, Stur, Sturb, Sturh, Stxp, Stxr,
        Stxrb,
    },
    register_instr::{
    ...
    simd_fp::{
        AddpScalar, AddpVector, AndVector, AsimdModImm, BitwiseInsert, CmeqRegScalar,
        CmeqRegVector, CmeqScalar, CmeqVector, CmhsRegisterScalar, CmhsRegisterVector, DupGeneral,
        Ext, FmovGeneral, InsAdvsimdGen, Ld1NoOffset, Ld1PostIndex, LdpSimdFpPostIndex,
        LdpSimdFpPreIndex, LdpSimdFpSignedOffset, LdrSimdFpPostIndex, LdrSimdFpPreIndex,
        LdrSimdFpUnsignedOffset, LdrSimdRegOffset, LdurSimd, Shrn, SshllAdvsimd, StrImdFpPostIndex,
        StrImdFpPreIndex, StrImdFpUnsignedOffset, StrPairFpPostIndex, StrPairFpPreIndex,
        StrPairFpSignedOffset, StrSimdRegOffset, SturSimdUnscaledOffset, Umaxp, Uminp, UmovAdvsimd,
    },
};
...
define_instructions!(
    ...
    Ldurb(Ldurb),
    LdrUnpriv(LdrUnpriv),
    LdrhUnpriv(LdrhUnpriv),
    LdrbUnpriv(LdrbUnpriv),
    ...
    InsAdvsimdGen(InsAdvsimdGen),
    SshllAdvsimd(SshllAdvsimd),
...
pub const DESCR: &[InstDesc] = &sort_by_specificity([
    ...
    LdrhUnpriv::LDRH_UNPRIV,
    LdrbUnpriv::LDRB_UNPRIV,
    ...
    InsAdvsimdGen::INS_ADVSIMD_GEN,
    SshllAdvsimd::SSHLL_01XX,
    SshllAdvsimd::SSHLL_001X,
    SshllAdvsimd::SSHLL_0001,

...
// ── Instruction Enum (generated by macro) ───────────────────────────────
...
define_instructions!(
    ...
    FaddVector(FaddVector),
    FcmltZeroVector(FcmltZeroVector),
    FcmpFloat(FcmpFloat),
    FcselFloat(FcselFloat),
    FsubFloat(FsubFloat),
    FcvtFloat(FcvtFloat),
    FabsFloat(FabsFloat),
    FnegFloat(FnegFloat),
...
pub const DESCR: &[InstDesc] = &sort_by_specificity([
    ...
    FaddVector::FADD_VECTOR,
    FcmltZeroVector::FCMLT_ZERO_VECTOR,
    FcmpFloat::FCMP_FLOAT,
    FcselFloat::FCSEL_FLOAT,
    FsubFloat::FSUB_FLOAT,
    FcvtFloat::FCVT_FLOAT,
    FabsFloat::FABS_FLOAT,
    FnegFloat::FNEG_FLOAT,
    ...
    OrrVector::ORR_VECTOR,
    BicVector::BIC_VECTOR,
    NotVector::NOT_VECTOR,
